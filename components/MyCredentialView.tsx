  ...
  return (
    <div className="min-h-full bg-slate-50 p-6 md:p-12 flex flex-col items-center justify-center space-y-8 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col items-center space-y-8 w-full max-w-md">
        <div 
          id="my-qr-badge" 
          className="bg-white rounded-[2.5rem] shadow-2xl overflow-hidden relative flex flex-col border border-slate-100"
        ...
        >
          ...
          {/* QR Area */}
          <div className="flex-1 flex flex-col items-center justify-center p-10 bg-white space-y-6">
          ...
          {/* Bottom Wave decoration like in PersonnelView */}
